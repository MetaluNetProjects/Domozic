...
extern int dcmotorDeltaPos, dcmotor_v, dcmotor_vabs;
extern t_dcmotorVars dcmotorVars;
extern t_dcmotorVolVars dcmotorVolVars;
extern long dcmotorDeltaT;//, dcmotorComputedSpeed; // last computed speed
...
#define DCMOTOR_GETSPEED(motID) (DCMOTOR(motID).Vars.computedSpeed)
